...
class Example(QMainWindow):
    ...
    def initUI(self):
        ...
        if os.path.isfile(Path('~/.ipfs/config').expanduser()) == False:
            startA(100,150)
        self.btn.move(5, 25)
        self.setWindowTitle('DeCast Windows Desktop version - IPFS Daemon Init')
        #print('5-------- End')
    ...
    def doAction(self):
        ...
        self.setWindowTitle('DeCast Windows Desktop version - Download Image from IPFS.......')
        self.repaint()
        ...
        self.setWindowTitle('DeCast Windows Desktop version - Image OK!')
        print('3-------- Ok')

    def doActionGetUploadedStructure(self):
        self.setWindowTitle('DeCast Windows Desktop version - Download Structure from IPFS.......')
        self.repaint()
        ...
        #print(b[:len(b)-1])
        jj = json.loads(output.decode('utf-8'))#(b[:len(b)-1])
        #jj = json.loads(a)
        ...
        self.setWindowTitle('DeCast Windows Desktop version - Download Structure OK!')
        print('3-------- Ok')
    ...
    def doActionUpload(self):
        ...
        self.setWindowTitle('DeCast Windows Desktop version - Starting Daemon.......')
        self.repaint()
        ...
        self.setWindowTitle('DeCast Windows Desktop version - Upload PosterFile to IPFS.......')
        self.repaint()
        ...
        #output, errors = p.communicate()
        #print(output.decode('utf-8'))
        with Popen(os.getcwd()+'/ipfs.exe add '+wb_patchPoster, stdout=PIPE, stderr=PIPE, shell=False, startupinfo=si) as p:
            output, errors = p.communicate()
        ...
        self.setWindowTitle('DeCast Windows Desktop version - Upload VideoFile to IPFS.......')
        self.repaint()
        print('--------------')
        ...
        #output, errors = p.communicate()
        #print(output.decode('utf-8'))
        with Popen(os.getcwd()+'/ipfs.exe add '+wb_patchVideo, stdout=PIPE, stderr=PIPE, shell=False, startupinfo=si) as p:
            output, errors = p.communicate()
            print(output.decode('utf-8').split(' ')[1])
        ...
        self.setWindowTitle('DeCast Windows Desktop version - Upload Structure to IPFS.......')
        self.repaint()
        ...
        #output, errors = p.communicate()
        #print(output.decode('utf-8'))
        with Popen(os.getcwd()+'/ipfs.exe add '+'json_data.json', stdout=PIPE, stderr=PIPE, shell=False, startupinfo=si) as p:
            output, errors = p.communicate()
            print(output.decode('utf-8').split(' ')[1])
        ...
        #self.btn.move(-200, -100)
        self.setWindowTitle('DeCast Windows Desktop version - Upload Structure OK!')
        print('3-------- Ok')
...
class PosterWindow(QMainWindow):
    ...
    def __call__(self, *args, **kwargs):
        ...
        self.setWindowTitle('DeCast Windows Desktop version - Download Poster from IPFS OK!')
        self.repaint()
...
class VideoWindow(QMainWindow):
    ...
    def __call__(self, *args, **kwargs):
        ...
        self.setWindowTitle('DeCast Windows Desktop version - Download Video from IPFS.......')
        self.repaint()
        ...
        self.setWindowTitle('DeCast Windows Desktop version - Download Video from IPFS OK!')
        self.repaint()
        ...
        self.setWindowTitle('DeCast Windows Desktop version - Start playing video!')
        self.repaint()
